...
export const isDateAllowed = (dateString, allowedDays) => {
...
export const isTimeAllowed = (timeStr, startTime, endTime, intervalMinutes = 30) => {
...
export const parseLegacyAvailabilityLabel = (availabilityLabel) => {
...
export const buildAvailabilityLabel = (workingDays, workingHoursStart, workingHoursEnd) => {
...
export const getMonthMarkedDates = (year, month, allowedDays = [], selectedDate = null) => {
  const marked = {};
